...
copytree(os.path.join("./cores",config['workshop']['core']['type'],"terraform", config['workshop']['core']['cloud_provider']), terraform_staging)
...
copytree(os.path.join("./cores",config['workshop']['core']['type'],"docker"), docker_staging)

# Copy asciidoc directory to .docker_staging
copytree(os.path.join("./cores",config['workshop']['core']['type'],"asciidoc"), os.path.join(docker_staging, "asciidoc"))
